...
df.to_csv('RIG.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('RIG.csv', sep=';')
df_new.to_csv('RIG_clean.csv', index = False, header = True, encoding="utf-8")