...
df.to_csv('LUG.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('LUG.csv', sep=';')
df_new.to_csv('LUG_clean.csv', index = False, header = True, encoding="utf-8")