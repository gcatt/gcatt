...
df.to_csv('MAG.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('MAG.csv', sep=';')
df_new.to_csv('MAG_clean.csv', index = False, header = True, encoding="utf-8")