...
df.to_csv('HAE.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('HAE.csv', sep=';')
df_new.to_csv('HAE_clean.csv', index = False, header = True, encoding="utf-8")