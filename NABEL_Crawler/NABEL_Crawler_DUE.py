...
df.to_csv('DUE.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('DUE.csv', sep=';')
df_new.to_csv('DUE_clean.csv', index = False, header = True, encoding="utf-8")