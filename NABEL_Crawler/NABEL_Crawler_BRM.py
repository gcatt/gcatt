...
type_station.send_keys('Beromünster')    ### Change per Station ###
...
df = pd.read_csv(r"C:\Users\ginoc\Downloads\BRM.csv", sep='delimiter', header=None)
df.drop([0,1,2,3,4], inplace = True)
df.to_csv(r"C:\Users\ginoc\Git_Repos\gcatt\NABEL_Crawler\Outputs\BRM.csv", index = False, header = False, encoding="utf-8")
df_new = pd.read_csv(r"C:\Users\ginoc\Git_Repos\gcatt\NABEL_Crawler\Outputs\BRM.csv", sep=';')
df_new.to_csv(r"C:\Users\ginoc\Git_Repos\gcatt\NABEL_Crawler\Outputs\R_Ready\BRM_clean.csv", index = False, header = True, encoding="utf-8")