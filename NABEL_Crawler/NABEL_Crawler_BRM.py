...
df.to_csv('BRM.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('BRM.csv', sep=';')
df_new.to_csv('BRM_clean.csv', index = False, header = True, encoding="utf-8")