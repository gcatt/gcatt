...
df.to_csv('DAV.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('DAV.csv', sep=';')
df_new.to_csv('DAV_clean.csv', index = False, header = True, encoding="utf-8")