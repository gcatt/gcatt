...
df.to_csv('TAE.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('TAE.csv', sep=';')
df_new.to_csv('TAE_clean.csv', index = False, header = True, encoding="utf-8")