...
type_station.send_keys('Zürich')    ### Change per Station ###
...
df.to_csv('ZUE.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('ZUE.csv', sep=';')
df_new.to_csv('ZUE_clean.csv', index = False, header = True, encoding="utf-8")