...
df.to_csv('SIO.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('SIO.csv', sep=';')
df_new.to_csv('SIO_clean.csv', index = False, header = True, encoding="utf-8")