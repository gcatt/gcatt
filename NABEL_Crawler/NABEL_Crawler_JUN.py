...
df.to_csv('JUN.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('JUN.csv', sep=';')
df_new.to_csv('JUN_clean.csv', index = False, header = True, encoding="utf-8")