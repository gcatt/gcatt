...
df.to_csv('PAY.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('PAY.csv', sep=';')
df_new.to_csv('PAY_clean.csv', index = False, header = True, encoding="utf-8")