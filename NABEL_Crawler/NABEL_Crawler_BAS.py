...
df.to_csv('BAS.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('BAS.csv', sep=';')
df_new.to_csv('BAS_clean.csv', index = False, header = True, encoding="utf-8")
