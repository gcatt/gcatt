...
df.to_csv('BER.csv', index = False, header = False, encoding="utf-8")
df_new = pd.read_csv('BER.csv', sep=';')
df_new.to_csv('BER_clean.csv', index = False, header = True, encoding="utf-8")