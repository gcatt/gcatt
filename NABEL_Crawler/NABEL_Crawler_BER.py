...
chrome_options.add_experimental_option("prefs", {
  "download.default_directory": r"C:\Users\ginoc\Git_Repos\gcatt\NABEL_Crawler",
...
type_station.send_keys('Bern')    ### Change per Station ###
...
df = pd.read_csv(r"C:\Users\ginoc\Downloads\BER.csv", sep='delimiter', header=None)
df.drop([0,1,2,3,4], inplace = True)
df.to_csv(r"C:\Users\ginoc\Git_Repos\gcatt\NABEL_Crawler\Outputs\BER.csv", index = False, header = False, encoding="utf-8")
df_new = pd.read_csv(r"C:\Users\ginoc\Git_Repos\gcatt\NABEL_Crawler\Outputs\BER.csv", sep=';')
df_new.to_csv(r"C:\Users\ginoc\Git_Repos\gcatt\NABEL_Crawler\Outputs\R_Ready\BER_clean.csv", index = False, header = True, encoding="utf-8")